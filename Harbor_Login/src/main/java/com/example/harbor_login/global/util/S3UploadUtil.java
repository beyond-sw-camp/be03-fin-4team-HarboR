package com.example.harbor_login.global.util;
...
public class S3UploadUtil {
    ...
    public ResponseEntity<byte[]> downloadFileBlob(String storedFileName, HttpServletRequest request) {
        ...
        try {
            S3Object s3Object = amazonS3Client.getObject(new GetObjectRequest(bucket, "images/" + storedFileName));
    ...
    public boolean download(String fileKey, String downloadFileName, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            fullObject = amazonS3Client.getObject(new GetObjectRequest(bucket, "images/" + fileKey));
            if (fullObject == null) {
                return false;
            }
    ...
    public void delete(String path) {
        amazonS3Client.deleteObject(bucket, "images/" + path);
    }
