...
const changePage = (newPage) => {
  ...
  store.fetchlistCards(newPage, type, value);
};
// 검색 함수
function changeSearch() {
  ...
  store.fetchlistCards(page, type, value);
}
      ...
      <UiParentCard title="Customer List">
        <v-row justify="space-between" class="align-center mb-3">
          ...
          <v-col cols="12" md="3">
            ...
            <select
              v-model="searchField"
              style="text-align: center; width: 100px; height: 30px; border: 1px solid black; border-radius: 5px; background-color: #f5f5f5"
            >
        ...
        <div class="overflow-auto">
          ...
          >
            ...
            <template #item-status="{ status }">
              ...
              <v-chip color="success" v-else-if="status === 'O01' || status === 'O06' || status === 'O07' || status === 'O08'" size="small">
                출근
              </v-chip>
